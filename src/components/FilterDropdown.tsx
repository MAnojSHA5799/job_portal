  ...
  return (
    <div className={cn("relative z-20", className)} ref={dropdownRef}>
      <button
        ...
        className={cn(
          "flex items-center gap-2 px-5 py-2.5 rounded-full border border-gray-100 bg-white/50 backdrop-blur-md transition-all hover:bg-white hover:shadow-lg hover:shadow-primary/5 active:scale-95 group",
          value !== label ? "border-primary/30 bg-primary/5 text-primary" : "text-gray-600"
        )}
      >
        <Icon className={cn("w-4 h-4", value !== label ? "text-primary" : "text-gray-400 group-hover:text-primary")} />
