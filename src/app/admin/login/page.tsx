  ...
  return (
    <div className="h-screen w-full flex bg-[#F4F7FB] overflow-hidden">
      ...
      <div className="hidden md:flex w-full md:w-[60%] h-full relative bg-white items-stretch">
        <img src="/lo.jpeg" alt="Admin Login Illustration" className="w-full h-full object-cover" />
      </div>
      ...
      <div className="w-full h-full md:w-[40%] px-8 py-8 md:px-12 xl:px-16 flex flex-col justify-center bg-[#F4F7FB] overflow-y-auto overflow-x-hidden no-scrollbar">
        <div className="max-w-[400px] w-full mx-auto">
          <h2 className="text-[28px] font-black text-center mb-2 text-gray-800 tracking-wide uppercase">ADMIN PANEL</h2>
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-gray-500 block px-1">Admin Email</label>
              <Input 
                type="email" 
            ...
            <div className="flex justify-between items-center text-xs font-semibold text-gray-400 px-1 pt-2">
              ...
              {/* <Link href="/forgot-password" className="hover:text-blue-500 transition-colors text-[#ADC5E3]">Forgot Password?</Link> */}
            </div>
          </form>
          
          <p className="mt-8 text-center text-xs text-gray-400 font-semibold">
            <Link href="/login" className="text-[#ADC5E3] hover:underline">Return to User Login</Link>
          </p>
        </div>
      </div>
